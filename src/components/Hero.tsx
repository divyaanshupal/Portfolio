  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-4 max-w-5xl mx-auto">
          {/* Left Side */}
          <div className="w-full md:w-3/5 flex flex-col items-start md:items-start text-left">
            <motion.h1 
            ...
            <div className="h-10 md:h-12 mb-8 relative w-full">
              <motion.p
                className="text-xl md:text-2xl lg:text-3xl font-medium text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 absolute"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <motion.span
                  ...
                  animate={{ opacity: [1, 1, 0, 0], scaleY: [1, 1.1, 1.1, 1] }}
